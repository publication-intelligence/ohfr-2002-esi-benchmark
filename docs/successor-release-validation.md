...
2. Select the policy/density evidence and construct/validate the actual common study lock. Preserve all correcting provenance. Commit these bound files as the actual artifact-freeze commit. No final commit/hash is supplied by this infrastructure.
